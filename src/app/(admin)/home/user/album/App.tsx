...
const App: React.FC<Props> = ({ albumData , userRef}) => {
  return (
    <Container>
        <div className="container mx-auto py-10 px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ...
                <Link href={`/home/user/album/photo?userRef=${userRef}&albumRef=${albumData._id}&photoRef=${photo._id}`} key={photo._id} className="group relative">
